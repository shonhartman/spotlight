...
export const meta = {
  ...
  description:
    'What if we could have an active conversation with the great thinkers of history? What if you could converse with a loved one after they have passed on? In this blog, we explore the potential of quantum computing and artificial intelligence to make these scenarios a reality.',
}
